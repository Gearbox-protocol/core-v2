...
export interface CreditManagerTestInternalInterface extends utils.Interface {
  functions: {
    ...
    "calcClosePaymentsPure(uint256,uint8,uint256,uint256)": FunctionFragment;
    "calcCreditAccountAccruedInterest(address)": FunctionFragment;
    "calcNewCumulativeIndex(uint256,uint256,uint256,uint256,bool)": FunctionFragment;
    ...
    "getSlotBytes(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "calcNewCumulativeIndex",
    values: [
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BigNumberish>,
      PromiseOrValue<BigNumberish>,
  ...
  encodeFunctionData(
    functionFragment: "emergencyLiquidation",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface CreditManagerTestInternal extends BaseContract {
  contractName: "CreditManagerTestInternal";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CreditManagerTestInternalInterface;
  ...
  functions: {
    ...
    calcNewCumulativeIndex(
      ...
      cumulativeIndexOpen: PromiseOrValue<BigNumberish>,
      isIncrease: PromiseOrValue<boolean>,
      overrides?: CallOverrides
    ): Promise<[BigNumber] & { newCumulativeIndex: BigNumber }>;
    ...
    getSlotBytes(
      slotNum: PromiseOrValue<BigNumberish>,
      overrides?: CallOverrides
