...
export interface TestPoolServiceInterface extends utils.Interface {
  functions: {
    ...
    "getCumulativeIndex_RAY()": FunctionFragment;
    "getDieselRate_RAY()": FunctionFragment;
    "getExpectedLU()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getCumulativeIndex_RAY",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "getExpectedLU",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "getTimestampLU",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "setExpectedLiquidity",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "updateBorrowRate",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface TestPoolService extends BaseContract {
  contractName: "TestPoolService";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestPoolServiceInterface;
  ...
  functions: {
    ...
    getCumulativeIndex_RAY(overrides?: CallOverrides): Promise<[BigNumber]>;

    getDieselRate_RAY(overrides?: CallOverrides): Promise<[BigNumber]>;

    getExpectedLU(overrides?: CallOverrides): Promise<[BigNumber]>;

    getTimestampLU(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    setExpectedLiquidity(
      newExpectedLiquidity: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  populateTransaction: {
    ...
    getExpectedLU(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    getTimestampLU(overrides?: CallOverrides): Promise<PopulatedTransaction>;
