...
export interface CreditFacadeTestHelperInterface extends utils.Interface {
  functions: {
...
export interface CreditFacadeTestHelper extends BaseContract {
  contractName: "CreditFacadeTestHelper";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CreditFacadeTestHelperInterface;
