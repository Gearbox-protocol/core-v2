...
export interface CreditFacadeTestEngineInterface extends utils.Interface {
  functions: {
...
export interface CreditFacadeTestEngine extends BaseContract {
  contractName: "CreditFacadeTestEngine";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CreditFacadeTestEngineInterface;
