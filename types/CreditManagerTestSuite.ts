...
export interface CreditManagerTestSuiteInterface extends utils.Interface {
  functions: {
    ...
    "gp()": FunctionFragment;
    "openCreditAccount()": FunctionFragment;
    "openCreditAccount(uint256)": FunctionFragment;
...
export interface CreditManagerTestSuite extends BaseContract {
  contractName: "CreditManagerTestSuite";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CreditManagerTestSuiteInterface;
  ...
  callStatic: {
    ...
    "openCreditAccount()"(
      ...
      [BigNumber, BigNumber, BigNumber, string] & {
        ...
        cumulativeIndexAtClose: BigNumber;
