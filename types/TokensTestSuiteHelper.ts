...
export interface TokensTestSuiteHelperInterface extends utils.Interface {
  functions: {
...
export interface TokensTestSuiteHelper extends BaseContract {
  contractName: "TokensTestSuiteHelper";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TokensTestSuiteHelperInterface;
