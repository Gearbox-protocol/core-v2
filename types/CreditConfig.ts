...
export interface CreditConfigInterface extends utils.Interface {
  functions: {
    "IS_TEST()": FunctionFragment;
    "_tokenTestSuite()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "_tokenTestSuite",
    values?: undefined
  ): string;
...
export interface CreditConfig extends BaseContract {
  contractName: "CreditConfig";
  ...
  functions: {
    ...
    _tokenTestSuite(overrides?: CallOverrides): Promise<[string]>;
    ...
    underlyingSymbol(overrides?: CallOverrides): Promise<[number]>;
  ...
  estimateGas: {
    ...
    _tokenTestSuite(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    _tokenTestSuite(overrides?: CallOverrides): Promise<PopulatedTransaction>;
