...
contract CreditManagerLimits is ICreditManagerV2Limits, ACLTrait {
    ...
    /// @dev Recalculates the cumulative index after changing the principal, to preserve the interest
    function _calcNewCumulativeIndexInterestPreserving(
        uint256 borrowedAmount,
        uint256 delta,
        uint256 cumulativeIndexNow,
        uint256 cumulativeIndexOpen,
        ...
        // We recompute the cumulative index to change the borrow amount (effectively increasing/decreasing the interest rate)
        // while keeping the currently accrued interest intact
