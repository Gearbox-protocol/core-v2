...
abstract contract ERC4626Prop is DSTest {
        ...
        return
            _call_vault(
                abi.encodeWithSelector(
                    IERC4626.convertToShares.selector,
                    assets
                )
            );
    }
    ...
    function vault_maxDeposit(address receiver) internal returns (uint256) {
        return
            _call_vault(
                abi.encodeWithSelector(IERC4626.maxDeposit.selector, receiver)
            );
    }
    ...
    function vault_maxMint(address receiver) internal returns (uint256) {
        return
            _call_vault(
                abi.encodeWithSelector(IERC4626.maxMint.selector, receiver)
            );
    }
    ...
    function vault_maxWithdraw(address owner) internal returns (uint256) {
        return
            _call_vault(
                abi.encodeWithSelector(IERC4626.maxWithdraw.selector, owner)
            );
    }
    ...
    function vault_maxRedeem(address owner) internal returns (uint256) {
        return
            _call_vault(
                abi.encodeWithSelector(IERC4626.maxRedeem.selector, owner)
            );
    }
    ...
    function vault_previewMint(uint256 shares) internal returns (uint256) {
        return
            _call_vault(
                abi.encodeWithSelector(IERC4626.previewMint.selector, shares)
            );
    }
    ...
    function vault_deposit(uint256 assets, address receiver)
        internal
        returns (uint256)
    {
        return
    ...
    function vault_mint(uint256 shares, address receiver)
        internal
        returns (uint256)
    {
        return
