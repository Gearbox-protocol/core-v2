...
abstract contract ERC4626Test is ERC4626Prop {
    ...
    function test_convertToShares(Init memory init, uint256 assets)
        public
        virtual
    {
        setUpVault(init);
    ...
    function test_convertToAssets(Init memory init, uint256 shares)
        public
        virtual
    {
        setUpVault(init);
    ...
    function test_previewDeposit(Init memory init, uint256 assets)
        public
        virtual
    {
        setUpVault(init);
    ...
    function test_previewWithdraw(Init memory init, uint256 assets)
        public
        virtual
    {
        setUpVault(init);
    ...
    function testFail_withdraw(Init memory init, uint256 assets)
        public
        virtual
    {
        setUpVault(init);
    ...
    function test_previewRedeem(Init memory init, uint256 shares)
        public
        virtual
    {
        setUpVault(init);
    ...
    function test_RT_deposit_redeem(Init memory init, uint256 assets)
        public
        virtual
    {
        setUpVault(init);
    ...
    function test_RT_deposit_withdraw(Init memory init, uint256 assets)
        public
        virtual
    {
        setUpVault(init);
    ...
    function test_RT_redeem_deposit(Init memory init, uint256 shares)
        public
        virtual
    {
        setUpVault(init);
    ...
    function test_RT_redeem_mint(Init memory init, uint256 shares)
        public
        virtual
    {
        setUpVault(init);
    ...
    function test_RT_mint_withdraw(Init memory init, uint256 shares)
        public
        virtual
    {
        setUpVault(init);
    ...
    function test_RT_mint_redeem(Init memory init, uint256 shares)
        public
        virtual
    {
        setUpVault(init);
    ...
    function test_RT_withdraw_mint(Init memory init, uint256 assets)
        public
        virtual
    {
        setUpVault(init);
    ...
    function test_RT_withdraw_deposit(Init memory init, uint256 assets)
        public
        virtual
    {
        setUpVault(init);
